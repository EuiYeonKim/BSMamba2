...
from model.modules.attend import Attend
...
class BSModel(Module):
    ...
    def __init__(
        ...
        *,
        ...
        time_module_depth=1,
        freq_module_depth=1,
        freqs_per_bands=DEFAULT_FREQS_PER_BANDS,  # in the paper, they divide into ~60 bands, test with 1 for starters
        dim_head=64,
        heads=8,
        attn_dropout=0.0,
        ff_dropout=0.0,
